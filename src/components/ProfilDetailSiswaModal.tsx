  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-slate-900 w-full max-w-4xl rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col max-h-[92vh] transition-colors">
        {/* MODAL HEADER */}
        <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50/70 dark:bg-slate-950/70">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-sky-100 dark:bg-sky-950/80 text-sky-700 dark:text-sky-300 flex items-center justify-center font-bold">
              <User className="w-5 h-5" />
            </div>
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100">
                  Profil & Rekap Detail Siswa PKL
                </h3>
                <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-sky-100 dark:bg-sky-950/80 text-sky-800 dark:text-sky-300 border border-sky-200 dark:border-sky-800">
                  {siswa.nis}
                </span>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                {siswa.nama_lengkap} • {siswa.kelas} ({siswa.jurusan})
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 transition cursor-pointer"
        ...
        <div className="px-5 py-4 bg-linear-to-r from-slate-900 via-sky-950 to-slate-900 text-white relative overflow-hidden">
          <div className="absolute top-0 right-0 w-80 h-80 bg-sky-500/10 rounded-full blur-3xl pointer-events-none" />

          <div className="relative flex flex-col sm:flex-row items-start sm:items-center gap-4">
            {/* Student Photo */}
            <div className="relative group shrink-0">
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden bg-slate-800 border-2 border-white/20 shadow-lg flex items-center justify-center">
                {displayPhoto ? (
                  <img
                    src={displayPhoto}
                  ...
                  <div className="w-full h-full bg-linear-to-br from-sky-500 to-indigo-600 flex items-center justify-center text-white font-extrabold text-2xl">
              ...
              {displayPhoto && (
                <button
                  ...
                  className="absolute bottom-1 right-1 p-1 bg-slate-900/80 text-white rounded-lg opacity-0 group-hover:opacity-100 transition-opacity text-[10px] flex items-center gap-1 shadow-md cursor-pointer"
                  title="Perbesar Foto"
                >
            ...
            <div className="flex-1 space-y-1.5">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="px-2 py-0.5 text-[10px] font-bold rounded-md bg-white/10 text-sky-200 border border-white/10">
                  NIS: {siswa.nis}
                </span>
              </div>
              ...
              {/* DUDI Placement preview badge */}
              <div className="pt-1 flex items-center gap-2 flex-wrap text-xs">
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-sky-500/20 text-sky-200 border border-sky-400/30">
                  <Building2 className="w-3.5 h-3.5 text-sky-400" />
                  <strong>{assignedDUDI?.nama_instansi || 'Belum Ditempatkan'}</strong>
                </span>
                {assignedGuru && (
                  <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-white/5 text-slate-300 border border-white/10 text-[11px]">
                    <ShieldCheck className="w-3.5 h-3.5 text-indigo-400" />
                    <span>Pembimbing: {assignedGuru.nama_guru}</span>
                  </span>
                )}
              </div>
            </div>
            ...
            <div className="flex sm:flex-col gap-2 shrink-0 w-full sm:w-auto pt-2 sm:pt-0">
              <button
                ...
                className="flex-1 sm:flex-initial px-3 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs flex items-center justify-center gap-1.5 transition shadow-xs cursor-pointer active:scale-95"
              ...
              <button
                ...
                className="flex-1 sm:flex-initial px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-sky-300 font-bold text-xs flex items-center justify-center gap-1.5 transition border border-slate-700 cursor-pointer active:scale-95"
        ...
        {/* NAVIGATION TABS */}
        <div className="px-5 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex items-center gap-2 overflow-x-auto">
          <button
            type="button"
          ...
          >
            ...
            <span className="ml-1 px-1.5 py-0.2 rounded-full text-[9px] font-bold bg-sky-100 dark:bg-sky-950/70 text-sky-700 dark:text-sky-300 border border-sky-300 dark:border-sky-800">
              Visual
            </span>
          </button>
          ...
          >
            ...
            <span>Histori Presensi ({studentPresensiList.length})</span>
          </button>
